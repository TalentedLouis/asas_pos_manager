            ...
            <form id="form1" name="form1"
                ...
                <div class="flex flex-wrap">
                    <div class="px-2 mb-4 w-1/4 sm:w-1/4 lg:w-1/4">
                        ...
                        <x-input id="entry_exit_money_code" class="w-full" type="text" name="entry_exit_money_code" :value="old('entry_exit_money_code', $config_regi->entry_exit_money_code)" required />
                    </div>
                </div>
