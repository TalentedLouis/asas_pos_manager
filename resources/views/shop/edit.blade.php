            ...
            <form id="form1" name="form1"
                ...
                <div class="flex flex-col">
                    <div class="px-2 mb-4 w-1/4 sm:w-1/4 lg:w-1/4">
                        <x-label for="code" class="w-full" value="店舗コード" />
                        <x-input id="code" class="w-full" type="number" name="code" :value="old('code', $shop->code)" required autofocus />
                    </div>
                    <div class="px-2 mb-4 w-1/4 sm:w-1/4 lg:w-1/4">
                        <x-label for="name" class="w-full" value="店舗名" />
                        <x-input id="name" class="w-full" type="text" name="name" :value="old('name', $shop->name)" required />
                    </div>
                </div>
