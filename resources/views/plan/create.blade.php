<x-base-layout>
    <x-slot name="title">利用プラン登録</x-slot>
    <x-slot name="slot">
        <div class="w-full">
            ...
            <form id="form1" name="form1"
                ...
                <div class="flex flex-wrap">
                    <div class="px-2 mb-4 w-1/4 sm:w-1/4 lg:w-1/4">
                        ...
                        <x-input id="use_minutes" class="w-full" type="number" name="use_minutes" :value="old('use_minutes')" />
                    </div>
                </div>
                <div class="flex flex-wrap">
                    <div class="px-2 mb-4 w-1/4 sm:w-1/4 lg:w-1/4">
                        <x-label for="use_start_hour" class="w-full" value="利用開始時間" />
                        <x-input id="use_start_hour" class="w-full" type="number" name="use_start_hour" :value="old('use_start_hour')" />
                    </div>
                    <div class="px-2 mb-4 w-1/4 sm:w-1/4 lg:w-1/4">
                        <x-label for="use_limit_hour" class="w-full" value="利用終了時間" />
                        <x-input id="use_limit_hour" class="w-full" type="number" name="use_limit_hour" :value="old('use_limit_hour')" />
                    </div>
                </div>
